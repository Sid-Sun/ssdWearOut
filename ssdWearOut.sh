...
welcome() {
	...
	echo " ";
	echo "Please note that I am NOT responsibe for anything that may happen, use this script at your OWN risk and don't run it unless you understand what you are doing.";
	echo " ";
	echo "Press the interrupt hotkeys to stop the script, it won't, otherwise; stop.";
	echo " ";
